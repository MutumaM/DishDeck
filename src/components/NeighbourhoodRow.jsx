...
import "./NeighbourhoodRow.css"

function NeighbourhoodRow(props) {
    const neighbourhoodName = props.neighbourhoodName;
    ...
    return (
            <section className="restaurant-row-section">
               <div className="restaurant-row-header">
                    <h3 className="restaurant-row-title">Restaurants in {neighbourhoodName}</h3>
               ...
               {!isLoading && !error && restaurants.length === 0 && (
                    <p>No restaurants found in {neighbourhoodName} right now.</p>
               )}
